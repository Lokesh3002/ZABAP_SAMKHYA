CLASS zsamkhya_travels DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zsamkhya_travels IMPLEMENTATION.
...
*   clear data
    DELETE FROM zabap_travel_dat.
    DELETE FROM zabap_travel_dat.

    "insert travel demo data
    INSERT zabap_travel_dat  FROM (
        SELECT
    ...
    COMMIT WORK.
    out->write( |[RAP100] Demo data generated for table Zabap_travel_dat{ group_id }. | ).
  ENDMETHOD.
ENDCLASS.
